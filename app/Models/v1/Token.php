...
class Token extends Model
{
    ...
    {
        return $this->hasMany(TokenAccess::class);
    }

    public function presets()
    {
        return $this->belongsToMany(Preset::class, 'token_preset')->as('access')->withPivot('can_create', 'can_read', 'can_update', 'can_delete');
    }
